                ...
                <h2>List of Jamb centres in Oyo town</h2>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="./UpdateLocation.php?Id=<?php echo $locationId; ?>" title="Edit Data" class="text-info">
                  <i class="fa fa-edit"></i>
                  </a>

                  <a href="./DeleteLocation.php?del=<?php echo $locationId; ?>" title="Delete Data" class="text-danger">
