	...
	<body>
		...
		<script>
			function initMap() {
			  var mapOptions = {
			    zoom: 18,
			    center: {<?php echo'lat:'. $latitudes[0] .', log:'. $longitudes[0] ;?>}, //{lat: --- , lng: ....}
			  ...
			  startPoint = {<?php echo'lat:'. $latitudes[0] .', log:'. $longitudes[0] ;?>};
			  endPoint = {<?php echo'lat:'.$latitudes[$lastcount] .', log:'. $longitudes[$lastcount] ;?>};
